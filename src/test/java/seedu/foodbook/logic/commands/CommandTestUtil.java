...
import static seedu.foodbook.testutil.TypicalDeliveries.AMY_DELIVERY;
...
public class CommandTestUtil {
    ...
    public static final String TAG_DESC_PERSONAL = " " + PREFIX_DELIVERY_TAG + VALID_TAG_PERSONAL;
     ...
     * - the food book, filtered person list and selected person in {@code actualModel} remain unchanged
     */
