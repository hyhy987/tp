...
public class JsonAdaptedDelivery {
     ...
     *
     * @param addressBook The address book providing the client list for lookup.
     * @return The model Delivery object.
     * @throws IllegalValueException If any field is missing or invalid.
     */
    public Delivery toModelType(ReadOnlyAddressBook addressBook) throws IllegalValueException {
        if (id == null) {
        ...
        Person client = addressBook.getPersonList().stream()
